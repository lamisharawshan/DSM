...
<a href="#" class="brand">
    <small>
        <!--<i class="icon-leaf"></i>-->
	    <img src="<?php echo base_url(); ?>assets/images/du_logo.jpg" height="54px" width="40px">
...
<div class="sidebar" id="sidebar">
    ...
    <ul class="nav nav-list">
        <li class="active">
			...
			<li >
			    <a href="<?php echo site_url('admin_management/institution');?>">
				    <i class="icon-desktop"></i>
		    ...
		    <li >
			    <a href="<?php echo site_url('upcoming_events/show_upcoming_events');?>">
				    <i class="icon-desktop"></i>
				    <span class="menu-text"> Upcoming Events </span>
			    </a>
		    </li>
		    <li >
			    <a href="<?php echo site_url('notice/notice_view');?>">
				    <i class="icon-desktop"></i>
