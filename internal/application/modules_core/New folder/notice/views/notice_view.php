...
<ul class="nav nav-tabs" id="myTab">
											...
											<div class="accordion-body collapse" id="collapseOne">
												<div class="accordion-inner">
													<?php $attributes = array('class' => 'form-horizontal'); echo form_open_multipart('notice/do_upload',$attributes);?>
                                                                 <div class="control-group" >
									                                  <label class="control-label" for="form-field-1">Notice Title</label>
                                                                 <div class="controls">
										                               <input type="text" id="form-field-1" name="Title" placeholder="Notice Title" required />
									                              </div>
								                                  </div>

                                                                 <div class="control-group" >
									                                  <label class="control-label" for="form-field-1">Notice Description</label>
                                                                 <div class="controls">
                            ...
                            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
										<thead>
											<tr>
												...
												<th class="hidden-480"   style="color:#3A87AD;">Description</th>
                                       ...
                                       foreach ($faculty_member as $col) {
											...
											<tr>
												<td>
                                                <?php echo $col->notice_Title?>
                                                </td>
                                                <td>
												<?php echo $col->description?>
                                                </td>
                                                <td >
                                                <a href="<?=base_url('application/modules_core/uploads/'.$col->notice_des)?>" target="_blank">view</a>
                                                </td>
                                                </td>
                                                <td class="center">
												<a class="btn btn-info btn-small tooltip-info" data-rel="tooltip" data-placement="bottom" title="" data-original-title="Bottm Info"  href='notice/download/<?php echo $col->notice_des?>'>download</a>
                                                </td>
					                            <td class="center">
								                <a class="btn btn-danger btn-small tooltip-error" data-rel="tooltip" data-placement="top" title="" data-original-title="Top Danger"  href='notice/delete_seminer/<?php echo $col->notice_des?>'>delete</a>
										        </td>
                                                </tr>
                                                       <?php
                                                         }
