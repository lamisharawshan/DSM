											...
											<div class="accordion-body collapse" id="collapseOne">
												<div class="accordion-inner">
													<?php $attributes = array('class' => 'form-horizontal'); echo form_open_multipart('student_documents/do_upload',$attributes);?>
									                             ...
									                             <label class="control-label" for="form-field-1">Assignment name</label>
                                                                                     <div class="controls">
										                                <input type="text" id="form-field-1" name="assname" placeholder="Assignment name" required />
									                                </div>
								                                 </div>
                                                                                  
                                                                                  <input type="hidden" name="documents_type" value="assignment" />
