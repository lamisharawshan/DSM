...
<div class="row-fluid">
    <div class="span12">
        <table id="sample-table-1" class="table table-striped table-bordered table-hover">
            ...
            <tbody id="show_all_news_events_details">
                ...
                <td>
                    <a href="#" role="button" class="green" data-toggle="modal">
                        <div class="hidden-phone visible-desktop btn-group">
                            <button class="btn btn-mini btn-success" name="modify_news_events_button" id="
        ...
        <div class="modal-body overflow-visible">
            <div class="row-fluid">
                ...
                <div class="span7">
                   ...
                   <!--         <select id="add_news_event_status">
        ...
        <div class="modal-body overflow-visible">
            <div class="row-fluid">
				...
				<div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="modify_event_header"
