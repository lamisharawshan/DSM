                            ...
                            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                       ...
                                       foreach ($faculty_member as $col) {
											...
											<tr>
					                            ...
					                            <td class="center">
								                <a class="btn btn-danger btn-small tooltip-error" data-rel="tooltip" data-placement="top" title="" data-original-title="Top Danger"  href='notice/delete_notice/<?php echo $col->notice_des?>'>delete</a>
										        </td>
                                                </tr>
                                                       <?php
                                                         }
