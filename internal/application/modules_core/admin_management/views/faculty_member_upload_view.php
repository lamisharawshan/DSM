											...
											<div class="accordion-body collapse" id="collapseOne">
												<div class="accordion-inner">
													<?php $attributes = array('class' => 'form-horizontal'); echo form_open_multipart('admin_management/do_upload',$attributes);?>
																...
																<div class="control-group" >
														           <label class="control-label" for="form-field-1">Profile link</label>
																    <div class="controls">
																  	<input type="text" id="form-field-1" name="Plink" placeholder="link"  />
																    </div>
															        </div>
                                                                      <div class="control-group">
                                       ...
                                       foreach ($faculty_member as $col) {
											...
											<tr>
												<td>
                                                                        ...
                                                                        <td>
                                                                        <img src="<?php echo base_url(); ?>application/modules_core/uploads/<?php echo $col->Picture;?>" alt="Smiley face" height="42" width="42">
                                                                        </td>
                                                                        <td >
                                                                        <a href="<?=base_url('application/modules_core/uploads/'.$col->pdfURL)?>" target="_blank">More info</a>

                                                                        </td>
                                                                         </td>
																        <td class="center">
																		<a class="btn btn-danger btn-small tooltip-error" data-rel="tooltip" data-placement="top" title="" data-original-title="Top Danger"  href='admin_management/delete_assignment/<?php echo $col->pdfURL?>'>delete</a>
																		</td>
