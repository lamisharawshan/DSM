...
<div class="row-fluid breadcrumbs margin-bottom-40">
    <div class="container">
        <h3 class="pull-left">Training list</h3>
        </div><!--/container-->
</div><!--/breadcrumbs-->
...
<ul class="nav nav-tabs" id="myTab">
											...
											<div class="accordion-body collapse" id="collapseOne">
												<div class="accordion-inner">
													<?php $attributes = array('class' => 'form-horizontal'); echo form_open_multipart('seminer_train/training_do_upload',$attributes);?>
                                                                 <div class="control-group" >
									                                  <label class="control-label" for="form-field-1">Training Title</label>
                                                                 <div class="controls">
										                               <input type="text" id="form-field-1" name="Title" placeholder="Training Title" required />
									                              </div>
								                                  </div>
								                                  <div class="control-group">
        ...
        <div  class="tab-pane in active">
                            ...
                            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                       ...
                                       foreach ($faculty_member as $col) {
											...
											<tr>
												<td>
                                                <?php echo $col->training_Title?>
                                                </td>
                                                <td >
                                                <a href="<?=base_url('application/modules_core/uploads/'.$col->training_des)?>" target="_blank">view</a>
                                                </td>
                                                </td>

                                                <td class="center">
							                    <a class="btn btn-info btn-small tooltip-info" data-rel="tooltip" data-placement="bottom" title="" data-original-title="Bottm Info"  href='seminer_train/training_download/<?php echo $col->training_des?>'>download</a>
                                                </td>
					                            <td class="center">
								                <a class="btn btn-danger btn-small tooltip-error" data-rel="tooltip" data-placement="top" title="" data-original-title="Top Danger"  href='seminer_train/delete_training/<?php echo $col->training_des?>'>delete</a>
										        </td>
											...
											<tr>
												<td>
                                                                        ...
                                                                        <?php echo $col->uploaded_time?>
                                                                         ...
                                                                         <td>
                                                                         <a class="btn btn-info btn-small tooltip-info" data-rel="tooltip" data-placement="bottom" title="" data-original-title="Bottm Info" href='student_documents/
                                                                         /<?php echo $col->document_dir?>'>download</a>
                                                                        </td>
																		 <td class="center">
