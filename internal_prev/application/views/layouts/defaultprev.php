...
<div class="top">
    <div class="container">
        <ul class="loginbar pull-right">
            ...
            <li><a href="<?php echo site_url('users/logout');?>" class="login-btn">Logout</a></li>
...
<!--=== End Top ===-->
    ...
    <div class="header">
                ...
                <div class="navbar-inner">
                    ...
                    <div class="nav-collapse collapse">
                        <ul class="nav top-2">
                            ...
                            <li>
                                <a href="" class="dropdown-toggle" data-toggle="dropdown">Seminar & Training
                                    <b class="caret"></b>
                                </a>
                                <ul class="dropdown-menu">
                                    <!-- <li><a href="<?php echo site_url('about_iit/institution'); ?>">About Department</a></li> -->
		...
		<!--                                <a href="<?php echo site_url('about_iit/choice_program_wise_batch'); ?>">Research and Publications </a> -->
                            ...
                            <li>
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Upcoming Events 
                                    <b class="caret"></b>
                                </a>
                                <ul class="dropdown-menu">

                                    <li><a href="<?php echo site_url('life_in_iit/newsandevents'); ?>">Create Events</a>
                                    </li>
                                    <li><a href="<?php echo site_url('life_in_iit/club'); ?>">Edit Events</a></li>
                                </ul>
                                <b class="caret-out"></b>
                            </li>
                            <li>
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Notice & Latest News
                                    <b class="caret"></b>
                                </a>
                                <ul class="dropdown-menu">	

                                    <li><a href="<?php echo site_url('life_in_iit/newsandevents'); ?>">Notice</a>
                                    </li>
                                    <li><a href="<?php echo site_url('life_in_iit/club'); ?>">Latest News</a></li>
                                </ul>
                                <b class="caret-out"></b>
                            </li>
                        </ul>
