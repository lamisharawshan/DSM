...
class seminer_train extends CI_Controller {
 public function __construct()
        {
            parent::__construct();

            $this->load->helper('download');
            $this->load->model('seminer_train_model','um',TRUE);
    ...
    public function seminer()
    {
		...
		$data['faculty_member']=$this->seminer_train_model->get_seminer();
	    $this->template->build('seminer_view',$data);
    }

    public function delete_seminer($file_dir)
	         {
	          $this->load->model('seminer_train_model');
	          if ($this->seminer_train_model->delete_file($file_dir))
	          {
	           	$this->seminer();
	          }
	          else
       ...
       else
      {
          ...
          $this->load->model('seminer_train_model');
          $file_id = $this->seminer_train_model->insert_file($Title, $file_name);
