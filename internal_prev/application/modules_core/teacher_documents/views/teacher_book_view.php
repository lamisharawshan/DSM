...
<div id="accordion2" class="accordion">
										     <div class="accordion-group">
											  <div class="accordion-heading" class="btn btn-info btn-small tooltip-info" data-rel="tooltip" data-placement="bottom" title="" data-original-title="Bottm Info">
											...
											<div class="accordion-body collapse" id="collapseOne">
												<div class="accordion-inner">
													<?php $attributes = array('class' => 'form-horizontal'); echo form_open_multipart('teacher_documents/do_upload',$attributes);?>
                                                                                <div class="control-group" >
									                             <label class="control-label" for="form-field-1">Books name</label>
                                                                                     <div class="controls">
    ...
    foreach ($course_info as $courses) {
        ...
        <div id="<?php echo $courses->course_id ?>" class="tab-pane in active">
                            ...
                            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
										<thead>
											<tr>
												<th class="hidden-480"  style="color:#3A87AD;">Book name</th>
										            <th class="hidden-480" style="color:#3A87AD;">User name</th>
											      
                                                                        <th class="hidden-480" style="color:#3A87AD;">Book description</th>
                                                                        <th class="hidden-480" style="color:#3A87AD;">Book size</th>
												...
												<td>
                                                                      ...
                                                                      <?php
                                                                       ...
                                                                       if($col->user_id == 20){
                                                                           ...
                                                                           ?>
                                                                      	 <td class="center">
                                                                         <a class="btn btn-danger btn-small tooltip-error" data-rel="tooltip" data-placement="top" title="" data-original-title="Top Danger"  href='teacher_documents/delete_book/<?php echo $col->document_dir?>'>delete</a>
                                                                         </td>
                                                                         <?php
                                                                          }
                                                                          ?>
                                                       ...
                                                       <?php
                                                        ...
                                                        if($nodata<1){
                                                       ?>
										<tr><td colspan='7'><?php echo 'No book is found under that course' ?></td></tr>
																<?php	}
																	?>
                                       ...
                                       foreach ($documents as $col) {
											...
											<tr>
												<td>
                                                       ...
                                                       if($nodata<1){
                                                       ?>
										<tr><td colspan='7'><?php echo 'No assignment are found under that course' ?></td></tr>
																<?php	}
																	?>
