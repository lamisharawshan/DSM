													...
													<?php $attributes = array('class' => 'form-horizontal'); echo form_open_multipart('teacher_documents/do_upload',$attributes);?>
									                             ...
									                             <label class="control-label" for="form-field-1">Book name</label>
										                                ...
										                                <input type="text" id="form-field-1" name="assname" placeholder="Book name" required />
                                                                                  ...
                                                                                  <input type="hidden" name="documents_type" value="other" />
                                                                                  ...
                                                                                  <div class="control-group">
                                                                                    ...
                                                                                    <div class="control-group">
									                                 <label class="control-label" for="form-field-1">Assignment description</label>
                                                                                       <div class="controls">
											...
											<tr>
												<td>
                                                       ...
                                                       <?php
                                                        ...
                                                        if($nodata<1){
                                                       ?>
										<tr><td colspan='7'><?php echo 'No files are found under that course' ?></td></tr>
																<?php	}
																	?>
											...
											<tr>
												<td>
                                                                        ...
                                                                        <?php echo $col->uploaded_time?>
                                                                         ...
                                                                         <td class="center">
                                                                         <a class="btn btn-danger btn-small tooltip-error" data-rel="tooltip" data-placement="top" title="" data-original-title="Top Danger"  href='teacher_documents/delete_doc/<?php echo $col->document_dir?>'>delete</a>
                                                                         </td>
