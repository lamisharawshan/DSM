$(function () {
    ...
    $("button[name='create_new_album_button']").click(function (e) {
    ...
    function create_album_pic_input_row() {
        var random = Math.floor(Math.random() * 1000) + 1;
        var new_input_tr = '' +
            '<tr id="input_picture_tr_' + random + '" >' +
            ...
            '   <td><button class="btn btn-small btn-danger pull-left" name="remove_input_row" id="' + random + '" >' +
    ...
    $("button[name='add_new_album_row']").click(function (e) {
        $('#input_pictures_tbody').append(create_album_pic_input_row());

        $("button[name='remove_input_row']").click(function (e) {
            var id = $(this).attr('id');
            $('#input_picture_tr_' + id).remove();

        });


        $('#modal_create_album input[type=file]').ace_file_input({
            style: 'well',
        ...
        $('#modal_create_album').on('show', function () {
    ...
    function create_new_album(){
        ...
        $.ajax({
            url: "site_management/create_new_album/",
            secureuri: false,
            fileElementId: 'album_picture',
            //type: "POST",
            dataType: "json",
            data:{'album_picture_description' : $('#album_picture_description').val()},
