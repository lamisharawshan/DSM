	...
	public function login($identity, $password, $remember=FALSE)
	{
		...
		if ($query->num_rows() === 1)
		{
			...
			if ($password === TRUE)
			{
				...
				//MANUALLY CREATED FOR DEFAULT VIEW
				$query_new=$this->db->query("select name from users, groups, users_groups
				...
				$session_data = array(
					...
					'user_type'            => $user_role->name  //MANUALLY CREATED FOR DEFAULT VIEW
				);
