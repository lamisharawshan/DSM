...
<div class="container">
	...
	<?php
     //for($i=1;$i<=12;$i++)
	 if(count($selected_batch_details)==0) echo "<div class='headline'><h4>No Batches Found</h4></div>";
	 else
	 foreach($selected_batch_details as $result)
	 {
	...
	?>
        ...
        <li class="span3">
            <div class="thumbnail-style">
                ...
                <h3><a><?php echo $result->batch_name;?></a> <small><?php echo $result->academic_status;?></small></h3>
                <p>Donec id elit non mi porta gravida at eget metus. Fusce dapibus, justo sit amet risus etiam porta sem...</p>
                <a class="btn-u btn-u-large btn-u-green one-page-btn" href="<?php echo site_url('about_iit/selected_batch_student/'.$result->batch_id);?>" ><i class="icon-bolt"></i> Details </a>
