...
<div class="row-fluid breadcrumbs margin-bottom-40">
    <div class="container">
        <h1 class="pull-left">Post Graduation</h1>
        <ul class="pull-right breadcrumb">
            <li><a href="<?php echo site_url('home/home');?>">Home</a> <span class="divider">/</span></li>
            <li><a href="">Academic</a> <span class="divider">/</span></li>
            <li class="active">Post Graduation</li>
        </ul>
    </div>
    <!--/container-->
</div>
    ...
    <div class="row-fluid">
        ...
        <div class="span12">
            ...
            <ul class="nav nav-tabs tabs">
                <li class="active"><a href="#home" data-toggle="tab">Program Details</a></li>
                <li><a href="#profile" data-toggle="tab">Addmission</a></li>
                <li><a href="#messages" data-toggle="tab">Notification</a></li>
            </ul><!--/tabs-->
